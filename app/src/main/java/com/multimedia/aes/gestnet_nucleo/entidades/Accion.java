...
public class Accion {
    ...
    public static final String ID_ACCION = "_id_accion";
    ...
    @DatabaseField(id = true, columnName = ID_ACCION)   private int id_accion;
    @DatabaseField(columnName = FK_PROTOCOLO)           private int fk_protocolo;
    @DatabaseField(columnName = DESCRIPCION_ACCION)     private String descripcion_accion;
    @DatabaseField(columnName = PERIOCIDAD_ACCION)      private String periocidad_accion;
    @DatabaseField(columnName = TIPO_ACCION)            private String tipo_accion;
    ...
    public void setId_accion(int id_protocolos) {
        this.id_accion = id_protocolos;
    }
