...
public class FirmarTecnico extends Activity implements View.OnClickListener {
    ...
    private String saveToInternalSorage(Bitmap bitmapImage){
        ...
        File mypath=new File(directory,"firmaTecnico"+mantenimiento.getId_mantenimiento()+".png");
