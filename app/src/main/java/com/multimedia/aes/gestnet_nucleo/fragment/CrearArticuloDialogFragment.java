                ...
                .setPositiveButton(R.string.crear, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if(etNombre.getText().toString().equals("") || etNombre.getText().toString()==null ||
                           etUnidades.getText().toString().equals("") ||  etUnidades.getText().toString()==null ||
                           etPrecio.getText().toString().equals("") ||  etPrecio.getText().toString()==null ||
                           etCoste.getText().toString().equals("") ||   etCoste.getText().toString()==null ||
                           etIva.getText().toString().equals("") ||     etIva.getText().toString()==null ||
                           etCantidadStock.getText().toString().equals("") || etCantidadStock.getText().toString()==null
                           ){
