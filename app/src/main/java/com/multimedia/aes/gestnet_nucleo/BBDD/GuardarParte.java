...
public class GuardarParte {
    ...
    public static void guardarJsonParte() throws JSONException, SQLException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            int fk_tipo_os0;
            if (jsonArray.getJSONObject(i).getString("fk_tipo_os0").equals("null") || jsonArray.getJSONObject(i).getString("fk_tipo_os0").equals("")) {
                fk_tipo_os0 = -1;
            } else {
                fk_tipo_os0 = jsonArray.getJSONObject(i).getInt("fk_tipo_os0");
            }
