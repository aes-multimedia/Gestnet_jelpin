...
//__________FUNCIONES DE CREACIÓN________________________//
    ...
    public static boolean newParte(Context context,int id_parte, int fk_user_creador, int fk_compania, int fk_tecnico, int fk_usuario,
        ...
        Parte p = montarParte(id_parte, fk_user_creador, fk_compania, fk_tecnico, fk_usuario,
                fk_direccion, fk_maquina,  fecha_creacion,  fecha_aviso,  fecha_visita,
                visita_duplicada,  fecha_reparacion, num_parte, fk_tipo, fk_user_asignacion,
                fk_horario,  horario,  duracion,  firmante,  sobre, franja_horaria,
                fk_estado, fk_estado_interno,  observaciones,  observacionesasignacion, confirmado,
                entregado_por,  recogido_por,  comentarios_entrega, fk_fabricante,  aprobado_fabricante,
                imprimir,  fecha_factura,  num_factura,  fecha_factura_rectificativa,  num_factura_rectificativa,
                fk_pend_fact,  num_orden_endesa,  fecha_maxima_endesa, fk_estado_endesa, insistencia_endesa,
                contrato_endesa,  producto_endesa, fk_tipo_os0, fk_tipo_producto, pagado_endesa,
                ciclo_liq_endesa, importe_pago_endesa,  fecha_pagado_endesa, pagado_operario,
                fecha_anulado,  fecha_modificacion_tecnico, fk_remoto_central,  fac_nombre,  fac_direccion,
                fac_cp,  fac_poblacion,  fac_provincia,  fac_dni,  fac_email,  fac_telefonos,
                otros_sintomas,  fecha_baja, fac_baja_stock, estado_android, urgencias,  lote,
                validar, liquidado_a_proveedor, fk_instalacion, fk_emergencia,  motivo_cambio_fecha_maxima,
                btodoslosequipos, fk_tipo_instalacion, parte_finalizado_android,  comercializadora,
                persona_contacto,  tel_contacto,  cnae, fk_compania_parte,  fecha_cierre,  num_presupuesto,
                defectos, fk_periocidad, franquicia,  inspeccion_visual,  otros_mataux, binspeccionvisual,
                botrosmataux);
