...
class TabFragment2_datosSiniestro : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_tab_fragment2_datos_siniestro, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment TabFragment2_datosSiniestro.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TabFragment2_datosSiniestro().apply {
