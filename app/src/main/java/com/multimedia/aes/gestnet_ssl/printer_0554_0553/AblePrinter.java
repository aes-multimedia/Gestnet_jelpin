...
public class AblePrinter extends com.multimedia.aes.gestnet_ssl.printer_0554_0553.Printer {
...
//		return spoolerThread.send(text.getBytes(), CR, LF);
	...
	public byte[] convertMultibyteCharsToByteArray(String text){
		try{
			...
			for (int i = 0; i < unicodeString.length(); i++){
				...
				int ecma94code = com.multimedia.aes.gestnet_ssl.printer_0554_0553.ECMA94.getTestoByteByUnicodeBytes(high, low);
	...
	public void printECMA94(){
		...
		int cnt = 0;
		for (com.multimedia.aes.gestnet_ssl.printer_0554_0553.ECMA94 i : ECMA94.values()){
