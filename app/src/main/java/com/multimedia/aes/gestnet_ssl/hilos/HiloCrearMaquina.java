...
public class HiloCrearMaquina extends AsyncTask<Void,Void,Void> {
    ...
    private String GuardarMaquina() throws JSONException{
        ...
        try {
            urlws = new URL("https://"+cliente.getIp_cliente()+Constantes.URL_CREA_MAQUINA);
            ...
            EnvioDAO.newEnvio(context,msg.toString(),"https://"+cliente.getIp_cliente()+Constantes.URL_CREA_MAQUINA,jsonArray.toString());
            e.printStackTrace();
