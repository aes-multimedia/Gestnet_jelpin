...
package com.multimedia.aes.gestnet_ssl.printer_0554_0553;
 ...
 */
public class BluetoothPrinterHelper implements com.multimedia.aes.gestnet_ssl.printer_0554_0553.PrinterHelper {
    /** 
	...
	public boolean connectTo(String device) {
		...
		if (success){
			...
			if (handler != null)
				handler.sendEmptyMessage(com.multimedia.aes.gestnet_ssl.printer_0554_0553.PrinterHelper.STATE_CONNECTED);
		} else{
			// inform client about fail
			if (handler != null)
				handler.sendEmptyMessage(com.multimedia.aes.gestnet_ssl.printer_0554_0553.PrinterHelper.STATE_CANNOT_CONNECT);
		}
	...
	public boolean connectTo(BluetoothDevice device) {
		...
		if (handler != null)
			handler.sendEmptyMessage(com.multimedia.aes.gestnet_ssl.printer_0554_0553.PrinterHelper.STATE_CONNECTING);
...
//			ret = device.createInsecureRfcommSocketToServiceRecord(UUID.randomUUID());
	...
	public synchronized void disconnect() {
		...
		if (isConnected()) {
			try {
				...
				if (handler != null)
					handler.sendEmptyMessage(com.multimedia.aes.gestnet_ssl.printer_0554_0553.PrinterHelper.STATE_DISCONNECTED);

			} catch (IOException e) {
				Log.e(TAG, "close() of connect socket failed", e);
				if (handler != null)
					handler.sendEmptyMessage(com.multimedia.aes.gestnet_ssl.printer_0554_0553.PrinterHelper.STATE_CANNOT_DISCONNECT);
			}
		}
	}
	...
	private class ListeningThread extends Thread {
		...
		public void run() {
			...
			if (handler != null)
				handler.sendEmptyMessage(com.multimedia.aes.gestnet_ssl.printer_0554_0553.PrinterHelper.STATE_LISTEN);
			...
			while (true) {
				try {
					...
					if (handler != null)
						handler.sendEmptyMessage(com.multimedia.aes.gestnet_ssl.printer_0554_0553.PrinterHelper.STATE_RECONNECTING);
