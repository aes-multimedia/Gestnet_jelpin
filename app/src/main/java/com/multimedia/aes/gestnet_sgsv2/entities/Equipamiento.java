...
public class Equipamiento {
    ...
    @DatabaseField(id = true, columnName = ID_EQUIPAMIENTO)
    ...
    public Equipamiento(){}
    public Equipamiento(int id_equipamiento, int fk_maquina, int fk_tipo_equipamiento, String potencia_fuegos, String codigo_equipamiento, String co2_equipamiento) {
