...
public class GuardarAveriasPreLogin {
    private static String Json;
    private static Context context;
    private static boolean bien=true;

    public GuardarAveriasPreLogin(Context context, String json) {
    ...
    public static void guardarJsonAverias() throws JSONException {
        ...
        if (bien){
            ...
            new GuardarMantenimientosPreLogin(context,Json);
        }else{
            ((PreLogin)context).sacarMensaje("error en averia");
