...
public class GuardarTipoCalderaPreLogin {
    private static String Json;
    private static Context context;
    private static boolean bien;

    public GuardarTipoCalderaPreLogin(Context context, String json) {
    ...
    public static void guardarJsonTipoCaldera() throws JSONException, SQLException {
        ...
        if (bien){
            ...
            new GuardarMarcaCalderaPreLogin(context,Json);
        }else{
            ((PreLogin)context).sacarMensaje("error tipo caldera");
        }
    }
}
