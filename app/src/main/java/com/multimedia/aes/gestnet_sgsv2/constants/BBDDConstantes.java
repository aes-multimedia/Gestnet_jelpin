...
public class BBDDConstantes {
	...
	public static Dao<TipoEquipamiento, Integer> tipoEquipamientoDao;
	...
	public static Dao<MaquinaMantenimiento, Integer> maquinaMantenimientoDao;
	...
	public static void crearTablas(ConnectionSource connectionSource) throws SQLException {
		...
		TableUtils.createTable(connectionSource, TipoEquipamiento.class);
		...
		TableUtils.createTable(connectionSource, MaquinaMantenimiento.class);
	...
	public static void borrarTablas(ConnectionSource connectionSource) throws SQLException {
		...
		TableUtils.dropTable(connectionSource, TipoEquipamiento.class, true);
		...
		TableUtils.dropTable(connectionSource, MaquinaMantenimiento.class, true);
	...
	public static void borrarDatosTablas(Context context) throws SQLException {
		...
		TipoEquipamientoDAO.borrarTodosLosTipoEquipamiento(context);
		...
		MaquinaMantenimientoDAO.borrarTodasLasMaquinaMantenimiento(context);
