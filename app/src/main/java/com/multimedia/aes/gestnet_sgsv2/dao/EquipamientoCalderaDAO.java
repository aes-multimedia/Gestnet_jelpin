...
public class EquipamientoCalderaDAO extends DBHelperMOS {
	...
	public static boolean newEquipamientoCaldera(Context context,int codigo, String potencia_fuegos, int fk_tipo_equipamiento, int fk_parte) {
		EquipamientoCaldera eq = montarEquipamientoCaldera(codigo, potencia_fuegos, fk_tipo_equipamiento, fk_parte);
	...
	public static EquipamientoCaldera montarEquipamientoCaldera(int codigo, String potencia_fuegos, int fk_tipo_equipamiento, int fk_parte) {
		EquipamientoCaldera eq =new EquipamientoCaldera(codigo, potencia_fuegos, fk_tipo_equipamiento, fk_parte);
		return eq;
	}
